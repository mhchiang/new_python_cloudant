...
class DesignDocument(Document):
    ...
    def filters(self):
        ...
        of the objects included in the changes feed.  If any of the function tests fail,
        the object is either removed or filtered from the feed.  If the function
        returns a true result when applied to a change, the change remains in the
        feed.
        ...
        :returns: Dictionary containing filter function names and objects
            as key/value
        """
